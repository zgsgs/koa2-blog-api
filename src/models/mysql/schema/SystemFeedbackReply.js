 ...
 * @LastEditTime: 2021-06-28 02:00:39
 * @LastEditors: jason
 * @Description: 系统反馈回复模型
 * @FilePath: \koa2-blog-api\src\models\mysql\schema\SystemFeedbackReply.js
 */
const { DataTypes } = require('sequelize')
const sequelize = require('@models/mysql')

const SystemFeedbackReply = sequelize.define('SystemFeedbackReply', {
  id: { type: DataTypes.INTEGER, primaryKey: true, allowNull: false, unique: true, autoIncrement: true, comment: '流水号' },
  // feedback_reply_id: { type: DataTypes.INTEGER, primaryKey: true, allowNull: false, unique: true, autoIncrement: true, comment:'反馈回复ID'},
...
module.exports = SystemFeedbackReply

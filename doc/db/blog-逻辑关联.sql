...
CREATE TABLE `blog_comments`  (
  ...
  `pid` int(11) NOT NULL DEFAULT 0 COMMENT '被回复评论ID 0-仅为评论',
...
CREATE TABLE `messages`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水号',
  `status` int(11) NOT NULL DEFAULT 0 COMMENT '状态 0-未启用',
  `pid` int(11) NOT NULL DEFAULT 0 COMMENT '被回复消息ID 0-仅为消息',
...
CREATE TABLE `system_dictionaries`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水号',
  `status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '状态',
  `type_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '字典类型ID',
...
CREATE TABLE `system_feedbacks`  (
  ...
  `pid` int(11) NOT NULL DEFAULT 0 COMMENT '被回复反馈ID 0-仅为反馈',
